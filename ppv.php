<?php
	...
	$operations = array('assign' => 'Assign', 'free' => 'Free', 'passwords' => 'Passwords', 'protection' => 'Protection');
	$selected_operation = getVal('operation', key($operations));
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//'EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		<title>SVP PPV API - Test Application</title>
	</head>
	<body style="background-color:#FFFFFF;color:#000000;">
		<div style="margin:0 auto;width:760px;border: 1px solid #EFEFEF;">
			...
			<? if($selected_operation) {
				include "ppv_".$selected_operation.".php";
			}
			?>
		</div>
	</body>
